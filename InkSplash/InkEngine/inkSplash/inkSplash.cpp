...
namespace MYGAME
{
    void NewManifestant() {
        ...
        app.CompCrea.CreateSpriteRenderer(Manifestant, "Manifestant5.png", InkEngine::SpriteRenderer::Center);
    ...
    int main()
    {
        ...
        app.CompCrea.CreateSpriteRenderer(BackGround, "THEVOID.png", InkEngine::SpriteRenderer::Center);
        ...
        //app.CreateComponentAndAttachToEntity<InkEngine::TextRenderer>(Camera);
